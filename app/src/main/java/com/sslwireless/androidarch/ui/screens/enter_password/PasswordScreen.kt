package com.sslwireless.androidarch.ui.screens.enter_password
...
@Destination
@Composable
fun PasswordScreen(navigator: DestinationsNavigator? = null) {
