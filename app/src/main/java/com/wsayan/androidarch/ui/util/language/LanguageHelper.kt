package com.wsayan.androidarch.ui.util.language
...
//            setApplicationLocale(context, locale)
    ...
    private fun load(context: Context): Locale {
        ...
        val language = preferences.getString(SELECTED_LANGUAGE, LanguageLocales.bengali.language)
        val country = preferences.getString(SELECTED_COUNTRY, LanguageLocales.bengali.country)
